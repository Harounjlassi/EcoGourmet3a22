...
public class UpdateCategoriesController  implements Initializable {
    ...
    void UpdateCategories(ActionEvent event) {
        ...
        if (t_cnom.getText().isEmpty()) {
            ...
            sc.update(new Categories(categorie.getId(), t_cnom.getText(), t_Cdescription.getText()));
    ...
    public void initData(Categories ct) {
        this.categorie = ct;
