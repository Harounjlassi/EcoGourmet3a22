    ...
    public class loginController implements Initializable {
        ...
        public void connexion(ActionEvent actionEvent) {
            if (!Email.getText().isEmpty() && !mdp.getText().isEmpty() && !userCaptchaAnswerField.getText().isEmpty()) {
                ...
                try {
                    String req = "select Role , Nom, Prenom, UserID ,Numero , Email from user where Email = '" + Email.getText() + "' AND Password='" + mdp.getText() +"'";
...
//
        ...
        private void generateCaptcha() {
            ...
            if (operatorIndex == 0) {
                result = num1 + num2;
                captchaLabel.setText("Veuillez résoudre l'équation : " + num1 + " + " + num2 + " = ?");
            } else {
                result = num1 - num2;
                captchaLabel.setText("Veuillez résoudre l'équation : " + num1 + " - " + num2 + " = ?");
            }
